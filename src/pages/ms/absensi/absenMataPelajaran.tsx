...
interface AbsensiMataPelajaranProps {
  class_id: string
  unit_id: string
  subject_id: string
  type: string
...
const AbsensiMataPelajaran = ({
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const params: DataParams = { school_id, unit_id, class_id, subject_id, type }
  ...
  }, [school_id, class_id, unit_id, subject_id, type])
...
export default AbsensiMataPelajaran
