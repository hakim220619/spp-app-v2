...
// ** Fetch Users
export const fetchDataCuti = createAsyncThunk('appUsers/fetchDataCuti', async (params: DataParams) => {
  ...
  const response = await axiosConfig.get('/list-Cuti', customConfig)

  return response.data
})

export const deleteCuti = createAsyncThunk(
  'appUsers/deleteCuti',
...
export const appUsersSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(fetchDataCuti.fulfilled, (state, action) => {
